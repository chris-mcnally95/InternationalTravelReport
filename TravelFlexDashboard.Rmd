...
Please note that in some cases a country status might not be assigned and will result in the omission of data.
...
valueBox(value = totalcases,
         caption = paste("Total Reported Cases from International Travellers as of ", format(Sys.Date(), "%d-%m-%Y")),
